...
const category = [...new Set(products.map((e) => e.category))];
//
// const brand = [...new Set(products.map((e) => e.brand))];

console.log(category.map((e => ({ value: e, label: e.split("-").join(" "), checked: false }))))

// console.log(brand.map((e) => ({ value: e, label: e, checked: false })));
